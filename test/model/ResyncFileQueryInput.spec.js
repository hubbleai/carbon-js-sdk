...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CarbonJsSdk.ResyncFileQueryInput();
  });
  ...
  describe('ResyncFileQueryInput', function() {
    it('should create an instance of ResyncFileQueryInput', function() {
      // uncomment below and update the code to test ResyncFileQueryInput
      //var instance = new CarbonJsSdk.ResyncFileQueryInput();
      //expect(instance).to.be.a(CarbonJsSdk.ResyncFileQueryInput);
    });
