...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CarbonJsSdk.SyncFilesRequest();
  });
  ...
  describe('SyncFilesRequest', function() {
    it('should create an instance of SyncFilesRequest', function() {
      // uncomment below and update the code to test SyncFilesRequest
      //var instance = new CarbonJsSdk.SyncFilesRequest();
      //expect(instance).to.be.a(CarbonJsSdk.SyncFilesRequest);
    });
