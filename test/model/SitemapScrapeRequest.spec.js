...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CarbonJsSdk.SitemapScrapeRequest();
  });
  ...
  describe('SitemapScrapeRequest', function() {
    it('should create an instance of SitemapScrapeRequest', function() {
      // uncomment below and update the code to test SitemapScrapeRequest
      //var instance = new CarbonJsSdk.SitemapScrapeRequest();
      //expect(instance).to.be.a(CarbonJsSdk.SitemapScrapeRequest);
    });
