...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CarbonJsSdk.FreshDeskConnectRequest();
  });
  ...
  describe('FreshDeskConnectRequest', function() {
    it('should create an instance of FreshDeskConnectRequest', function() {
      // uncomment below and update the code to test FreshDeskConnectRequest
      //var instance = new CarbonJsSdk.FreshDeskConnectRequest();
      //expect(instance).to.be.a(CarbonJsSdk.FreshDeskConnectRequest);
    });
