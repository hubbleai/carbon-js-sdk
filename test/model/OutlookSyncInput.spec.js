...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CarbonJsSdk.OutlookSyncInput();
  });
  ...
  describe('OutlookSyncInput', function() {
    it('should create an instance of OutlookSyncInput', function() {
      // uncomment below and update the code to test OutlookSyncInput
      //var instance = new CarbonJsSdk.OutlookSyncInput();
      //expect(instance).to.be.a(CarbonJsSdk.OutlookSyncInput);
    });
