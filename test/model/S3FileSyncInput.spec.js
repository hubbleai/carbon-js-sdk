...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CarbonJsSdk.S3FileSyncInput();
  });
  ...
  describe('S3FileSyncInput', function() {
    it('should create an instance of S3FileSyncInput', function() {
      // uncomment below and update the code to test S3FileSyncInput
      //var instance = new CarbonJsSdk.S3FileSyncInput();
      //expect(instance).to.be.a(CarbonJsSdk.S3FileSyncInput);
    });
