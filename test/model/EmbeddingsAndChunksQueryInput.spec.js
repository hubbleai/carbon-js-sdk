...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CarbonJsSdk.EmbeddingsAndChunksQueryInput();
  });
  ...
  describe('EmbeddingsAndChunksQueryInput', function() {
    it('should create an instance of EmbeddingsAndChunksQueryInput', function() {
      // uncomment below and update the code to test EmbeddingsAndChunksQueryInput
      //var instance = new CarbonJsSdk.EmbeddingsAndChunksQueryInput();
      //expect(instance).to.be.a(CarbonJsSdk.EmbeddingsAndChunksQueryInput);
    });
