...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CarbonJsSdk.GmailSyncInput();
  });
  ...
  describe('GmailSyncInput', function() {
    it('should create an instance of GmailSyncInput', function() {
      // uncomment below and update the code to test GmailSyncInput
      //var instance = new CarbonJsSdk.GmailSyncInput();
      //expect(instance).to.be.a(CarbonJsSdk.GmailSyncInput);
    });
