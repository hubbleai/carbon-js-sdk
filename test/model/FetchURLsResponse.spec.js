...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CarbonJsSdk.FetchURLsResponse();
  });
  ...
  describe('FetchURLsResponse', function() {
    it('should create an instance of FetchURLsResponse', function() {
      // uncomment below and update the code to test FetchURLsResponse
      //var instance = new CarbonJsSdk.FetchURLsResponse();
      //expect(instance).to.be.a(CarbonJsSdk.FetchURLsResponse);
    });
