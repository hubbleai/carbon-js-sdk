...
/**
 * The RSSFeedInput model module.
 * @module model/RSSFeedInput
 * @version 1.0.0
 */
class RSSFeedInput {
    /**
     * Constructs a new <code>RSSFeedInput</code>.
     * @alias module:model/RSSFeedInput
     * @param url {Object} 
     */
    constructor(url) { 
        
        RSSFeedInput.initialize(this, url);
    }
    ...
    /**
     * Constructs a <code>RSSFeedInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RSSFeedInput} obj Optional instance to populate.
     * @return {module:model/RSSFeedInput} The populated <code>RSSFeedInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RSSFeedInput();
    ...
    /**
     * Validates the JSON data with respect to <code>RSSFeedInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RSSFeedInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RSSFeedInput.RequiredProperties) {
            if (!data[property]) {
...
RSSFeedInput.RequiredProperties = ["url"];

/**
 * @member {Object} url
 */
RSSFeedInput.prototype['url'] = undefined;

/**
 * @member {module:model/Tags1} tags
 */
RSSFeedInput.prototype['tags'] = undefined;

/**
 * @member {module:model/ChunkSize1} chunk_size
 */
RSSFeedInput.prototype['chunk_size'] = undefined;

/**
 * @member {module:model/ChunkOverlap1} chunk_overlap
 */
RSSFeedInput.prototype['chunk_overlap'] = undefined;

/**
 * @member {module:model/SkipEmbeddingGeneration} skip_embedding_generation
 */
RSSFeedInput.prototype['skip_embedding_generation'] = undefined;

/**
 * @member {module:model/EmbeddingGenerators} embedding_model
 */
RSSFeedInput.prototype['embedding_model'] = undefined;

/**
 * @member {module:model/GenerateSparseVectors} generate_sparse_vectors
 */
RSSFeedInput.prototype['generate_sparse_vectors'] = undefined;

/**
 * @member {module:model/PrependFilenameToChunks} prepend_filename_to_chunks
 */
RSSFeedInput.prototype['prepend_filename_to_chunks'] = undefined;
